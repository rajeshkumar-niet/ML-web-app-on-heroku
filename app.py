...
with st.sidebar:
    predictions = [ 'Big  Mart Sales','Breast_cancer_model_Prediction','Calories_Burnt_Prediction','Loan Approval Prediction']
...
if(selected == 'Breast_cancer_model_Prediction'):
    ...
    def main():
        ...
        # Collect inputs for all features with default values
        ...
        if st.button("Predict Cancer Type"):
            try:
                ...
                # result = "Malignant" if diagnosis == 1 else "Benign"  # Adjust based on your model's output
...
if(selected == 'Calories_Burnt_Prediction'):
